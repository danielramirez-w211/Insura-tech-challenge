...
{
    public sealed class RegisterPaymentHandler : IRequestHandler<RegisterPaymentCommand, ClaimResponse>
    {
        private readonly IClaimRepository _claimRepository;
        private readonly IUnitOfWork _unitOfWork;

        public RegisterPaymentHandler(IClaimRepository claimRepository, IUnitOfWork unitOfWork)
        {
            _claimRepository = claimRepository;
            _unitOfWork = unitOfWork;
        }

        public async Task<ClaimResponse> Handle(RegisterPaymentCommand request,CancellationToken cancellationToken)
        {
            ...
            claim.RegisterPayment(request.ResponsibleUser, request.Observations);
