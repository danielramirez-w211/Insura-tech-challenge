...
public sealed class PoliciesController : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        var command = new CreatePolicyCommand
        {
            ...
            InsuredGender       = request.Insured.Gender,
            InsuredAddress      = request.Insured.Address,
            InsuredCityName     = request.Insured.CityName,
            InsuredPostalCode   = request.Insured.PostalCode,
            InsuredDepartment   = request.Insured.Department,
